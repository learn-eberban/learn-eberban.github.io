...
{/* 
   TODO replace the following list with ReactFlow, once the issue is fixed
   https://github.com/wbkd/react-flow/issues/2929
*/}
...
The use of "vhowel" is here to make explanations easier, it'll only be seen in
this chapter.
...
<Info type="examples">
- mi: property for "_ is the singular first person/speaker/author, i.e. 'I'"
- pa: begins an assertive sentence—that which the speaker asserts to be true.
</Info>
...
<Info type="examples">
- ber: property for "_ is Eberbanic/reflects Eberbanic culture".
- ban: property for "_ is a language".
- mana: relation for "_ is a (social) mother of _"
- viru: relation for "_ sees _"
</Info>
...
<Info type="examples">
- pcien: property for "_ is bread".
- ckual: property for "_ is a planet".
- pra: relation for "_ loves _"
- gli: relation for "_ is happy that _ is true".
</Info>
...
<Info type="examples">
- eufranse'stan: property for "_ is France".
- euinglic'ban: property for "_ is the English language".
- za u'unicef: property for "_ is named UNICEF".
</Info>
...
- za uhenri ufordo: property for "_ is named Henry Ford".
- za uhenri be ufordo: property for "_ is named Henry and is a "Ford". (Maybe
...
<Info type="examples">
- "e" marks a two-word compound: `eberban` (property for "_ is the eberban
language").
- "a" marks a three-word compound: `acepobu` (property for "is a dictionary").
...
Now `ipandoran` is the property "_ is the home planet of the Na'vi" (those
three particles will be explained later).
</Info>
