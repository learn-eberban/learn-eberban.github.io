...
\{E,A,O,U\}. They follow this order, e.g., the first and second overt places of
a predicate are "E" and "A" respectively.
...
of arguments a predicate may be bound to by its places.

"mian" is bound to any number of arguments of quantity `tce*` and type `pan` at
its `E` place.
