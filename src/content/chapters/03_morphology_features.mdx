...
When we get to the [Word Types chapter](/chapters/word-types), we'll teach you each of their structures.
...
Here are all of the symbols. You'll see them again in the
[Word Types chapter](/chapters/word-types) as a dropdown.
