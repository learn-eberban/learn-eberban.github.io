...
Eberban is phonetic, that is, each letter is pronounced and only pronounced one
way. Here's how your pronunce them:
...
similarly-looking ones are accepted. `'` is spelt as "uhu" but pronounced as a
pause.

Also, note that the combination of the letters "tc" and "dj" match the English
pronunciation of "ch" and "j" respectively.
...
instead of vowels "i" and "u" respectively. 
...
distinction. Sonorants never begin a word.
...
front of the mouth (p, b) to sounds made in the back (k, g).

You may have even noticed that the pronunciations of the unvoiced consonants end
in "i", and that the spellings of the voiced consonants end in "u".
...
its [word&nbsp;type](/chapters/word-types).
- Except for "i", they are used to denote
[predicate&nbsp;places](/chapters/eberban-predicates#places).
