...
- TODO check link to dictionary
- TODO check pronoun usage. Be warmer with we and you and active voice.
...
You've already seen some of these dictinoary entries in previous chapters. These
entries are in inline form, and it's how Learn Eberban will mainly display them.
They look like this:

- <DictEntry client:load inline id="la6bqysk7n" />

In the dictionary, you'll see them in block form:

<DictEntry client:load id="t98puegdx0" />

TODO Let's break this down:
...
This course striclty differentiates between meaning and definition. All words
have meanings, only some have definitions.
