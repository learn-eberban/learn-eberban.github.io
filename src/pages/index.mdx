...
<SiteLayout chapter={0} title="So, what is Learn Eberban?">

<Info type="warning" title="OUT OF DATE & INDEFINITE HIATUS">
    Eberban has been updated considerably, making this course out of date.
    Overarching concepts are still accurate like "A Little Logic" and "Arity
    Mismatch Resolution", but concrete explanations and examples like "The
    Alphabet" and "Morphology Features" are no longer.

    There's no telling when this course will be updated. Please see the
    Reference Grammar and the Discord Server for your learning journey.
</Info>

This course teaches [Eberban](https://eberban.github.io/eberban/) up to an
intermediate level. If, after having completed this course, you were teleported
to Eberstan (the country of the Eberbanic people), then you would blend in just
fine. For further technical coverage, see the
